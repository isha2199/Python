    ...
    fallback_data = [
        {
            ...
            "Genre": "Action, Sci-Fi",
            "Overview": "A thief who steals corporate secrets through dream-sharing technology is offered a chance to erase his past.",
            "IMDB_Rating": 8.8,
        },
        {
            "Series_Title": "The Dark Knight",
            "Genre": "Action, Crime, Drama",
            "Overview": "When the menace known as the Joker emerges, Batman must confront chaos and corruption in Gotham.",
            "IMDB_Rating": 9.0,
        },
        {
            "Series_Title": "The Lion King",
            "Genre": "Animation, Adventure, Drama",
            "Overview": "A young lion prince grows into his destiny and learns the importance of family and courage.",
            "IMDB_Rating": 8.5,
        },
        {
            "Series_Title": "La La Land",
            "Genre": "Comedy, Drama, Music",
            "Overview": "A jazz pianist and an aspiring actress fall in love while chasing their dreams in Los Angeles.",
            "IMDB_Rating": 8.0,
        },
        {
            "Series_Title": "The Social Network",
            "Genre": "Biography, Drama",
            "Overview": "Mark Zuckerberg creates a social networking site that transforms communication and friendship worldwide.",
            "IMDB_Rating": 7.8,
        },
    ]
...
csv_path = Path(__file__).resolve().with_name("imdb_top_1000.csv")
